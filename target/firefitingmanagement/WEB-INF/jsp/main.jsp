...
<div class="fire_container">
    ...
    <div class="fire_body" style="position:relative; top:-15px;">
        ...
        <!-- 中间轮播图内容 -->
        <div class="fire_main_ad col-sm-10">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 style="text-align: center;">欢迎进入XXX公司人力资源管理系统！</h3>
                </div>
                <div class="panel-body" style="position:relative; top:-15px;">
                    <div id="fire_carousel_1" class="carousel slide" data-ride="carousel">
                        <ol class="carousel-indicators">
                            <li data-target="#fire_carousel_1" data-slide-to="0" class="active"></li>
                            <li data-target="#fire_carousel_1" data-slide-to="1"></li>
                            <li data-target="#fire_carousel_1" data-slide-to="2"></li>
                        </ol>
                        ...
                        <!-- Controls -->
                        <a class="left carousel-control" href="#fire_carousel_1" role="button" data-slide="prev">
                            <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
                            <span class="sr-only">Previous</span>
                        </a>
                        <a class="right carousel-control" href="#fire_carousel_1" role="button" data-slide="next">
