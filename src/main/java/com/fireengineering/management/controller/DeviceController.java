...
//     * @return
//     */
//    @RequestMapping(value = "/clearAllDevice", method = RequestMethod.GET)
////    @ResponseBody
//    public String clearAllDevice() {
//        employeeService.deleteAllDevice();
//        return "redirect:/hrms/emp/getDeviceList";
//    }
    ...
    @ResponseBody
    public JsonMsg checkDeviceExists(@RequestParam("deviceName") String deviceName){
        //对输入的姓名与邮箱格式进行验证
