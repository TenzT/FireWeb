...
<body>
<div class="fire_brand_nav">
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container-fluid">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#fire-navbar-collapse-1" aria-expanded="false">
            ...
            <div class="collapse navbar-collapse" id="fire-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu nav nav-pills nav-stacked">
                            ...
                            <li><a href="#" class="fire_logout"><span class="glyphicon glyphicon-off" aria-hidden="true"></span> 账号退出</a></li>
                        </ul>
                    </li>
...
<script type="text/javascript">
    ...
    $("#company_logo").click(function () {
        $(this).attr("href", "/fire/main");
    });
    //账号退出
    $(".fire_logout").click(function () {
        window.location.href = "/fire/logout";
    });
</script>
</body>
</html>
