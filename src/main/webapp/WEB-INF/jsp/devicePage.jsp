        ...
        <div class="device_info col-sm-10">
            <div class="panel panel-success">
                ...
                <div class="panel-heading">
                    ...
                    <div>
                        <a href="#" class="device_add_btn" data-toggle="modal" data-target=".device-add-modal">新增设备</a>
                    </div>
                </div>
                    <!-- Table -->
                        ...
                        <tbody>
                            <c:forEach items="${devices}" var="dev">
                                <tr>
                                    ...
                                    <td>${dev.img}</td>
                                    <td>
                                        <a href="#" role="button" class="btn btn-primary device_update_btn" data-toggle="modal" data-target=".device-update-modal">编辑</a>
...
<%@ include file="deviceAdd.jsp"%>        <!--嵌入设备增加脚本，相当于直接写到本页面上-->
<%@ include file="deviceUpdate.jsp"%>
